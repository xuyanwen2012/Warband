...
namespace Nez.PhysicsShapes
{
    public static partial class ShapeCollisions
    {
        ...
        static bool circleToPolygon2(Circle circle, Polygon polygon, out CollisionResult result)
        {
            ...
            var closest1 = closestPointOnLine(
                polygon.points[prePointIndex],
                polygon.points[closestPointIndex],
                circleCenter);
            var closest2 = closestPointOnLine(
                polygon.points[closestPointIndex],
                polygon.points[postPointIndex],
                circleCenter);
