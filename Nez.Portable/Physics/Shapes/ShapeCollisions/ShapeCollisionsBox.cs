...
namespace Nez.PhysicsShapes
{
    ...
    public static partial class ShapeCollisions
    {
        ...
        [Obsolete]
        public static bool polygonToPolygonCast(
            Polygon first,
            Polygon second,
        ...
        [Obsolete]
        static bool polygonToPolygon(
            Polygon first,
            Polygon second,
            Vector2? deltaMovement,
            out Vector2 responseNormal,
        ...
        static bool intervalIntersect(
            Polygon first,
            Polygon second,
            ref Vector2 axis,
            ref Vector2 shapeOffset,
            ref Vector2? deltaMovement,
            out float taxis)
        {
