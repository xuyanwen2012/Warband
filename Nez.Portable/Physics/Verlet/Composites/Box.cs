...
namespace Nez.Verlet
{
    ...
    public class Box : Composite
    {
            ...
            float diagonalStiffness = 0.5f)
        {
            ...
            // inside diagonals
            addConstraint(new DistanceConstraint(tl, br, diagonalStiffness)).setCollidesWithColliders(false);
            addConstraint(new DistanceConstraint(bl, tr, diagonalStiffness)).setCollidesWithColliders(false);
        }
    }
}