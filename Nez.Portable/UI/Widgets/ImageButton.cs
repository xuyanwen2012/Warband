...
namespace Nez.UI
{
    ...
    public class ImageButton : Button
    {
        ...
        public ImageButton(Skin skin, string styleName = null)
        ...
        public ImageButton(IDrawable imageUp, IDrawable imageDown, IDrawable imageOver)
            : this(new ImageButtonStyle(null, null, null, imageUp, imageDown, imageOver))
        {
        }
