...
namespace Nez.UI
{
    public class ImageTextButton : Button
    {
        ...
        public ImageTextButton(string text, Skin skin, string styleName = null)
    ...
    public class ImageTextButtonStyle : TextButtonStyle
    {
        ...
        public ImageTextButtonStyle(IDrawable up, IDrawable down, IDrawable over, BitmapFont font)
            : base(up, down, over, font)
        {
        }
