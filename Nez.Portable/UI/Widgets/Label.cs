...
namespace Nez.UI
{
    public class Label : Element
    {
        ...
        public Label(string text, BitmapFont font, Color fontColor)
            : this(text, new LabelStyle(font, fontColor))
        {
        }
        ...
        public Label(string text)
            : this(text, Graphics.instance.bitmapFont)
        {
        }
        ...
        public override void draw(Graphics graphics, float parentAlpha)
        {
            ...
            graphics.batcher.drawString(
                _style.font,
                _wrappedString,
                new Vector2(x, y) + _textPosition,
                _style.fontColor,
                0,
                Vector2.Zero,
                new Vector2(_fontScaleX, _fontScaleY),
                SpriteEffects.None,
                0);
        }
    }
    ...
    public class LabelStyle
    {
        ...
        public LabelStyle(Color fontColor)
            : this(null, fontColor)
        {
        }
        ...
        {
            return new LabelStyle { fontColor = fontColor, font = font, background = background };
        }
    }
}