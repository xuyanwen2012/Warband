...
namespace Nez.UI
{
    public class TextButton : Button
    {
        ...
        public TextButton(string text, Skin skin, string styleName = null)
        ...
        public override void draw(Graphics graphics, float parentAlpha)
        {
            ...
            else if (isChecked && (!_mouseOver && style.checkedFontColor.HasValue
    ...
    public class TextButtonStyle : ButtonStyle
    {
        ...
        public TextButtonStyle(IDrawable up, IDrawable down, IDrawable over, BitmapFont font)
            : base(up, down, over)
        {
            this.font = font ?? Graphics.instance.bitmapFont;
        }

        public TextButtonStyle(IDrawable up, IDrawable down, IDrawable over)
            : this(up, down, over, Graphics.instance.bitmapFont)
        {
        }
