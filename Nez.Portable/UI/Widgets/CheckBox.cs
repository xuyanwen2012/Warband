...
namespace Nez.UI
{
    ...
    public class CheckBox : TextButton
    {
        ...
        public CheckBox(string text, Skin skin, string styleName = null)
    ...
    public class CheckBoxStyle : TextButtonStyle
    {
        ...
        public IDrawable checkboxOff;

        /** Optional. */
        public IDrawable checkboxOver;

        public IDrawable checkboxOnDisabled;

        public IDrawable checkboxOffDisabled;
