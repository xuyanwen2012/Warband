...
namespace Nez.UI
{
    public class SelectBox<T> : Element, IInputListener
        where T : class
    {
        ...
        public SelectBox(Skin skin)
            : this(skin.get<SelectBoxStyle>())
        {
        }

        public SelectBox(Skin skin, string styleName = null)
        ...
        public override void layout()
        {
            ...
            if (bg != null)
                _prefHeight = Math.Max(
                    bg.topHeight + bg.bottomHeight + font.lineHeight - font.descent * 2f,
                    bg.minHeight);
            else
            ...
            if (_selectBoxList == null || !_selectBoxList.isScrollingDisabledY())
                listWidth += Math.Max(
                    style.scrollStyle.vScroll != null ? style.scrollStyle.vScroll.minWidth : 0,
    ...
    public class SelectBoxStyle
    {
        ...
        public IDrawable backgroundOpen;

        public IDrawable backgroundDisabled;
