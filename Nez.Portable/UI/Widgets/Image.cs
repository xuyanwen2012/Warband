...
namespace Nez.UI
{
    public class Image : Element
    {
        ...
        public Image(Subtexture subtexture, Scaling scaling = Scaling.Stretch, int align = AlignInternal.center)
            : this(new SubtextureDrawable(subtexture), scaling, align)
        {
        }

        public Image(Texture2D texture, Scaling scaling = Scaling.Stretch, int align = AlignInternal.center)
            : this(new Subtexture(texture), scaling, align)
        {
        }
        ...
        public override float preferredWidth
        {
            get
            {
                return _drawable != null ? _drawable.minWidth : 0;
            }
        }
        ...
        public override float preferredHeight
        {
            get
            {
                return _drawable != null ? _drawable.minHeight : 0;
            }
        }
