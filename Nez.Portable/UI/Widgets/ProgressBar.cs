...
namespace Nez.UI
{
    public class ProgressBar : Element
    {
        ...
        public override float preferredWidth
        {
            get
            {
                if (_vertical)
                    return Math.Max(
                        style.knob == null ? 0 : style.knob.minWidth,
        ...
        public override float preferredHeight
        {
            get
            {
                if (_vertical)
                    ...
                    return Math.Max(
                        style.knob == null ? 0 : style.knob.minHeight,
        ...
        public ProgressBar(Skin skin, string styleName = null)
            : this(0, 1, 0.01f, false, skin)
        {
        }
            ...
            if (_vertical)
            {
                ...
                if (knobAfter != null)
                {
                    knobAfter.draw(
                        ...
                        knobAfter.minWidth,
                        height - position - knobHeightHalf,
                        color);
                }
            ...
            else
            {
                ...
                if (knobBefore != null)
                {
                    ...
                    knobBefore.draw(
                        graphics,
                        x + offset,
                        y + (int)((height - knobBefore.minHeight) * 0.5f),
                        (int)(position + knobWidthHalf),
    ...
    public class ProgressBarStyle
    {
        ...
        /// Optional
        /// </summary>
        public IDrawable knobAfter;

        /// <summary>
        /// Optional
        /// </summary>
        public IDrawable disabledKnobBefore;

        /// <summary>
        /// Optional
        /// </summary>
        public IDrawable disabledKnobAfter;
        ...
        public static ProgressBarStyle create(Color knobBeforeColor, Color knobAfterColor)
        {
            ...
            return new ProgressBarStyle { knobBefore = knobBefore, knobAfter = knobAfter };
        }
        ...
        public static ProgressBarStyle createWithKnob(Color backgroundColor, Color knobColor)
        {
            ...
            return new ProgressBarStyle { background = background, knob = knob };
        }
