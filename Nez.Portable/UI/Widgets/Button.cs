...
namespace Nez.UI
{
    public class Button : Table, IInputListener, IGamepadFocusable
    {
        ...
        public Button(Skin skin, string styleName = null)
            : this(skin.get<ButtonStyle>(styleName))
        {
        }
        ...
        public Button(IDrawable up, IDrawable down, IDrawable checked_)
            : this(new ButtonStyle(up, down, checked_))
        {
        }
