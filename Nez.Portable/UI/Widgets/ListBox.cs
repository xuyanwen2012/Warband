...
namespace Nez.UI
{
    ...
    /// </summary>
    public class ListBox<T> : Element, IInputListener
        where T : class
    {
        ...
        public ListBox(Skin skin, string styleName = null)
        ...
        public override void draw(Graphics graphics, float parentAlpha)
        {
            ...
            var unselectedFontColor = new Color(
                _style.fontColorUnselected,
                (int)(_style.fontColorUnselected.A * parentAlpha));
            var selectedFontColor = new Color(
                _style.fontColorSelected,
                (int)(_style.fontColorSelected.A * parentAlpha));
