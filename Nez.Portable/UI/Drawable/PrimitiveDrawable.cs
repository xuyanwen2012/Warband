...
namespace Nez.UI
{
    public class PrimitiveDrawable : IDrawable
    {
        ...
        public PrimitiveDrawable(Color color, float horizontalPadding)
            : this(color)
        {
            leftWidth = rightWidth = horizontalPadding;
        }

        public PrimitiveDrawable(Color color, float horizontalPadding, float verticalPadding)
            : this(color)
        {
            leftWidth = rightWidth = horizontalPadding;
        ...
        public PrimitiveDrawable(float minWidth, float minHeight, Color? color = null)
            : this(color)
        {
        ...
        public PrimitiveDrawable(float minSize)
            : this(minSize, minSize)
        {
        }

        public PrimitiveDrawable(float minSize, Color color)
            : this(minSize, minSize, color)
        {
        }
