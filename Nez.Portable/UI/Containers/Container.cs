...
namespace Nez.UI
{
    ...
    public class Container : Group
    {
        ...
        Value _minWidthValue = Value.minWidth;

        Value _minHeightValue = Value.minHeight;

        Value _prefWidthValue = Value.prefWidth;

        Value _prefHeightValue = Value.prefHeight;

        Value _maxWidthValue = Value.zero;

        Value _maxHeightValue = Value.zero;

        Value _padTop = Value.zero;

        Value _padLeft = Value.zero;

        Value _padBottom = Value.zero;

        Value _padRight = Value.zero;
