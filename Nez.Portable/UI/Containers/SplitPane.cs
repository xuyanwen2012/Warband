...
namespace Nez.UI
{
    public class SplitPane : Group, IInputListener
    {
        ...
        public SplitPane(Element firstWidget, Element secondWidget, IDrawable handle, bool vertical = false)
            : this(firstWidget, secondWidget, new SplitPaneStyle(handle), vertical)
        {
        }

        public SplitPane(SplitPaneStyle style, bool vertical = false)
            : this(null, null, style, vertical)
        {
        }
    ...
    public class SplitPaneStyle
    {
        ...
        {
            return new SplitPaneStyle { handle = handle };
        }
    }
}