...
namespace Nez.UI
{
    public class Cell : IPoolable
    {
        ...
        static private int topi = AlignInternal.top;

        static private int bottomi = AlignInternal.bottom;

        static private int lefti = AlignInternal.left;

        static private int righti = AlignInternal.right;

        static private bool files;

        static private Cell defaults;

        internal Value minWidth;

        internal Value minHeight;

        internal Value prefWidth;

        internal Value prefHeight;

        internal Value maxWidth;

        internal Value maxHeight;

        internal Value spaceTop;

        internal Value spaceLeft;

        internal Value spaceBottom;

        internal Value spaceRight;

        internal Value padTop;

        internal Value padLeft;

        internal Value padBottom;

        internal Value padRight;
