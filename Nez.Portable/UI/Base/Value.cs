...
namespace Nez.UI
{
    ...
    public abstract class Value
    {
        ...
        {
            return new PercentWidthValue() { percent = percent };
        }
        ...
        {
            return new PercentWidthDelegateValue() { delegateElement = delegateElement, percent = percent };
        }
        ...
        {
            return new PercentageHeightValue() { percent = percent };
        }
        ...
        {
            return new PercentHeightDelegateValue() { delegateElement = delegateElement, percent = percent };
        }
