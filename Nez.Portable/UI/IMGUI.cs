...
#pragma warning disable 0414
        ...
        static bool isMouseOverElement()
        {
            var rect = new Rectangle(
                (int)_elementX,
                (int)_lastY + (int)ELEMENT_PADDING,
                (int)_elementWidth,
                (int)ELEMENT_HEIGHT);
        ...
        public static bool toggle(string text, bool isChecked)
        {
            ...
            if (isChecked || isToggleActive)
                _spriteBatch.drawRect(
                    toggleX + 3,
                    _lastY + ELEMENT_PADDING + 3,
                    ELEMENT_HEIGHT - 6,
                    ELEMENT_HEIGHT - 6,
                    toggleCheckColor);
        ...
        public static float slider(float value, string name = "")
        {
            ...
            _spriteBatch.drawRect(
                _elementX + thumbPos,
                _lastY + ELEMENT_PADDING,
                SHORT_ELEMENT_HEIGHT,
                SHORT_ELEMENT_HEIGHT,
                color);
        ...
        public static void header(string text)
        {
            ...
            _spriteBatch.drawRect(
                _elementX - ELEMENT_PADDING,
                _lastY + ELEMENT_PADDING,
                _elementWidth + ELEMENT_PADDING * 2,
                SHORT_ELEMENT_HEIGHT,
                HEADER_BG);
