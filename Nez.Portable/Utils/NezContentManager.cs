...
namespace Nez.Systems
{
    ...
    public class NezContentManager : ContentManager
    {
        ...
        public NezContentManager(IServiceProvider serviceProvider, string rootDirectory)
            : base(serviceProvider, rootDirectory)
        {
        }

        public NezContentManager(IServiceProvider serviceProvider)
            : base(serviceProvider)
        {
        }

        public NezContentManager()
            : base(Core._instance.Services, Core._instance.Content.RootDirectory)
        {
        }
        ...
        /// <returns>The effect.</returns>
        /// <param name="name">Name.</param>
        public T loadEffect<T>(string name)
            where T : Effect
        {
        ...
        /// <returns>The effect.</returns>
        /// <param name="name">Name.</param>
        internal T loadEffect<T>(string name, byte[] effectCode)
            where T : Effect
        {
    ...
    {
        public NezGlobalContentManager(IServiceProvider serviceProvider, string rootDirectory)
            : base(serviceProvider, rootDirectory)
        {
        }
