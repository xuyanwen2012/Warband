...
namespace Nez
{
    public static class ComponentExt
    {
        ...
        public static T addComponent<T>(this Component self, T component)
            where T : Component
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T getComponent<T>(this Component self)
            where T : Component
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void getComponents<T>(this Component self, List<T> componentList)
            where T : class
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static List<T> getComponents<T>(this Component self)
            where T : Component
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool removeComponent<T>(this Component self)
            where T : Component
        {
