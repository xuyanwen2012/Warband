    ...
    public partial class DebugConsole
    {
        ...
        internal void render()
        {
            ...
            var commandEntryRect = RectangleExt.fromFloats(
                HORIZONTAL_PADDING,
                screenHeight - LINE_HEIGHT * renderScale,
                workingWidth,
                LINE_HEIGHT * renderScale);
            ...
            Graphics.instance.batcher.drawString(
            ...
            if (_drawCommands.Count > 0)
            {
                ...
                for (var i = 0; i < _drawCommands.Count; i++)
                {
                    ...
                    var position = new Vector2(
                        HORIZONTAL_PADDING + TEXT_PADDING_X,
        ...
        void buildCommandsList()
        {
            ...
            try
            {
                ...
                var ignoredAssemblies = new string[]
                                            {
                                                "mscorlib", "MonoMac", "MonoGame.Framework", "Mono.Security", "System",
                                                "OpenTK", "ObjCImplementations", "Nez"
                                            };
        ...
        void processMethod(MethodInfo method, CommandAttribute attr)
        {
            ...
            {
                throw new Exception(
                    method.DeclaringType.Name + "." + method.Name + " is marked as a command, but is not static");
            }
            else
            {
