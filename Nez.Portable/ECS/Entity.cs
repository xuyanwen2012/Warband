...
namespace Nez
{
    public class Entity : IComparable<Entity>
    {
        ...
        public float rotationDegrees
        {
            ...
            set
            {
                transform.setRotationDegrees(value);
            }
        }
        ...
        public float localRotationDegrees
        {
            ...
            get
            {
                return transform.localRotationDegrees;
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
                transform.setLocalRotationDegrees(value);
            }
        }
        ...
        public Matrix2D worldInverseTransform
        {
            ...
            get
            {
                return transform.worldInverseTransform;
            }
        }
        ...
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public void getComponents<T>(List<T> componentList)
            where T : class
        {
        ...
        public T addCollider<T>(T collider)
            where T : Collider
        {
        ...
        [Obsolete("Colliders are now Components. Use the normal Component methods to manage Colliders.")]
        public T getCollider<T>(bool onlyReturnInitializedColliders = false)
            where T : Collider
        {
        ...
        public override string ToString()
        {
            return string.Format(
                "[Entity: name: {0}, tag: {1}, enabled: {2}, depth: {3}]",
                name,
                tag,
                enabled,
                updateOrder);
