...
namespace Nez.Particles
{
    ...
    public class Particle
    {
        ...
        public void initialize(ParticleEmitterConfig emitterConfig, Vector2 spawnPosition)
        {
            ...
            _degreesPerSecond = MathHelper.ToRadians(
                emitterConfig.rotatePerSecond + emitterConfig.rotatePerSecondVariance * Random.minusOneToOne());
            ...
            var startA = MathHelper.ToRadians(
                emitterConfig.rotationStart + emitterConfig.rotationStartVariance * Random.minusOneToOne());
            var endA = MathHelper.ToRadians(
                emitterConfig.rotationEnd + emitterConfig.rotationEndVariance * Random.minusOneToOne());
            rotation = startA;
        ...
        public bool update(
            ...
            ref ParticleCollisionConfig collisionConfig,
            Vector2 rootPosition)
        {
            ...
            if (_timeToLive > 0)
            {
                ...
                if (collisionConfig.enabled)
                {
                    ...
                    _circleCollisionShape.recalculateBounds(
                        particleSize * 0.5f * collisionConfig.radiusScale,
                        pos + position);
                    var neighbors = Physics.boxcastBroadphase(
                        ref _circleCollisionShape.bounds,
                    ...
                    foreach (var neighbor in neighbors)
                    {
                        ...
                        if (_circleCollisionShape.collidesWithShape(neighbor.shape, out result))
                        {
                            ...
                            calculateCollisionResponseVelocity(
                                collisionConfig.friction,
                                collisionConfig.elasticity,
