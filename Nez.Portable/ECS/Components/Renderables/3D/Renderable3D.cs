...
namespace Nez
{
    ...
    public abstract class Renderable3D : RenderableComponent
    {
        ...
        public Vector3 position
        {
            get
            {
                return new Vector3(transform.position, _positionZ);
            }
        ...
        public Vector3 rotation
        {
            get
            {
                return new Vector3(_rotationXY, transform.rotation);
            }
        ...
        public Vector3 rotationDegrees
        {
            get
            {
                return new Vector3(_rotationXY, transform.rotation) * Mathf.rad2Deg;
            }

            set
            {
                rotation = value *= Mathf.deg2Rad;
            }
        }
