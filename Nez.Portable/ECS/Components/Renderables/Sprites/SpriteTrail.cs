...
namespace Nez.Sprites
{
    ...
    public class SpriteTrail : RenderableComponent, IUpdatable
    {
        ...
        class SpriteTrailInstance
        {
            ...
            public void setSpriteRenderOptions(
                float rotation,
                Vector2 origin,
                Vector2 scale,
        ...
        public int maxSpriteInstances
        {
            get
            {
                return _maxSpriteInstances;
            }

            set
            {
                setMaxSpriteInstances(value);
            }
        }
        ...
        void spawnInstance()
        {
            ...
            instance.setSpriteRenderOptions(
                _sprite.entity.transform.rotation,
                _sprite.origin,
                _sprite.entity.transform.scale,
                _sprite.spriteEffects,
                layerDepth);
