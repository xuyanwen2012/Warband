...
namespace Nez.Sprites
{
    ...
    /// </summary>
    public class Sprite<TEnum> : Sprite, IUpdatable
        where TEnum : struct, IComparable, IFormattable
    {
        ...
        public Sprite(IEqualityComparer<TEnum> customComparer = null)
            : base(Graphics.instance.pixelTexture)
        {
        ...
        public Sprite(TEnum animationKey, SpriteAnimation animation)
            : this(null, animation.frames[0])
        {
