...
namespace Nez.Sprites
{
    ...
    public class Sprite : RenderableComponent
    {
        ...
        public Vector2 originNormalized
        {
            ...
            {
                return new Vector2(
                    _origin.X / width * entity.transform.scale.X,
            ...
            set
            {
                setOrigin(
                    new Vector2(
                        value.X * width / entity.transform.scale.X,
        ...
        {
            setOrigin(
                new Vector2(value.X * width / entity.transform.scale.X, value.Y * height / entity.transform.scale.Y));
            return this;
        }
        ...
        public override void render(Graphics graphics, Camera camera)
        {
            graphics.batcher.draw(
                _subtexture,
                entity.transform.position + localOffset,
                color,
                entity.transform.rotation,
                origin,
                entity.transform.scale,
