...
namespace Nez
{
    ...
    public class TiledSprite : Sprite
    {
            ...
            : base(subtexture)
        {
            ...
            material = new Material { samplerState = Core.defaultWrappedSamplerState };
        }

        public TiledSprite(Texture2D texture)
        ...
        public override void render(Graphics graphics, Camera camera)
        {
            ...
            var destinationRect = RectangleExt.fromFloats(
                topLeft.X,
                topLeft.Y,
