    ...
    public class SpringGrid : RenderableComponent, IUpdatable
    {
            ...
            for (var y = 1; y < height; y++)
            {
                for (var x = 1; x < width; x++)
                {
                    ...
                    if (x > 1)
                    {
                        ...
                        var mid = Vector2.CatmullRom(
                            projectToVector2(_points[x - 2, y].position),
                            left,
                            p,
                            projectToVector2(_points[clampedX, y].position),
                            0.5f);
                    ...
                    if (y > 1)
                    {
                        ...
                        var mid = Vector2.CatmullRom(
                            projectToVector2(_points[x, y - 2].position),
                            up,
                            p,
                            projectToVector2(_points[x, clampedY].position),
                            0.5f);
        ...
        void drawLine(Batcher batcher, Vector2 start, Vector2 end, Color color, float thickness = 2f)
        {
            ...
            batcher.draw(
                ...
                start + entity.transform.position + localOffset,
