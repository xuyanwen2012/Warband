    ...
    public class TextRun
    {
        ...
        public void compile()
        {
            ...
            for (var i = 0; i < _text.Length; ++i)
            {
                ...
                var destination = new Vector4(
                    p.X,
                    p.Y,
                    currentFontRegion.width * _scale.X,
                ...
                _charDetails[i].verts[1].X =
                    (rotationMatrix2X * cornerY) + (rotationMatrix1X * cornerX) + destination.X;
                _charDetails[i].verts[1].Y =
                    (rotationMatrix2Y * cornerY) + (rotationMatrix1Y * cornerX) + destination.Y;
        ...
        public void render(Graphics graphics)
        {
            for (var i = 0; i < _charDetails.Length; i++)
                graphics.batcher.drawRaw(
                    _charDetails[i].texture,
                    _charDetails[i].verts,
                    _charDetails[i].texCoords,
