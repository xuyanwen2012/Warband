...
namespace Nez
{
    ...
    public class MarkupText : RenderableComponent
    {
        ...
        public MarkupText(float textWidth)
            : this()
        {
                        ...
                        case "br":
                            {
                                ...
                                else
                                {
                                    ...
                                    currentTotalHeight +=
                                        currentFormatting.font.lineSpacing * currentFormatting.scale.Y;
                                }
        ...
        Vector2 wrapLine(
            Vector2 position,
            List<ICompiledElement> lineBuffer,
            ...
            out float currentLineHeight)
        {
            ...
            for (var i = 0; i < lineBuffer.Count; i++)
                lineBuffer[i].position = new Vector2(
                    lineBuffer[i].position.X + xOffset,
                    position.Y + currentLineHeight / 2f);
    ...
    struct CompiledTextElement : ICompiledElement
    {
        ...
        public void render(Graphics graphics, Vector2 offset)
        {
            ...
            graphics.batcher.drawString(
                _formatInstruction.font,
                _text,
                offset + position,
                _formatInstruction.color,
                0,
                origin,
                _formatInstruction.scale,
                SpriteEffects.None,
                0);
        }
    }
