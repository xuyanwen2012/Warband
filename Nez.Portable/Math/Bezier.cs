...
namespace Nez.Splines
{
    ...
    public static class Bezier
    {
            ...
            float t)
        {
            t = Mathf.clamp01(t);
            var oneMinusT = 1f - t;
            return oneMinusT * oneMinusT * oneMinusT * start + 3f * oneMinusT * oneMinusT * t * firstControlPoint
        ...
        /// <param name="end">P3.</param>
        /// <param name="t">T.</param>
        public static Vector2 getFirstDerivative(
            Vector2 start,
            Vector2 firstControlPoint,
            Vector2 secondControlPoint,
            Vector2 end,
        ...
        static void recursiveGetOptimizedDrawingPoints(
            Vector2 start,
            Vector2 firstCtrlPoint,
            ...
            float distanceTolerance)
        {
            ...
            var d2 = System.Math.Abs(
                (firstCtrlPoint.X - end.X) * deltaLine.Y - (firstCtrlPoint.Y - end.Y) * deltaLine.X);
            var d3 = System.Math.Abs(
                (secondCtrlPoint.X - end.X) * deltaLine.Y - (secondCtrlPoint.Y - end.Y) * deltaLine.X);
        ...
        /// <param name="end">End.</param>
        /// <param name="distanceTolerance">Distance tolerance.</param>
        public static List<Vector2> getOptimizedDrawingPoints(
            Vector2 start,
            Vector2 firstCtrlPoint,
            Vector2 secondCtrlPoint,
            Vector2 end,
