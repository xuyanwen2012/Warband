...
namespace Nez.DeferredLighting
{
    ...
    public class DeferredLightingRenderer : Renderer
    {
        ...
        public DeferredLightingRenderer(int renderOrder, int lightLayer, params int[] renderLayers)
            : base(renderOrder)
        {
            ...
            setAmbientColor(new Color(0.2f, 0.2f, 0.2f)).setClearColor(Color.CornflowerBlue);
        }
        ...
        void renderLights(Scene scene)
        {
            ...
            {
                Assert.isTrue(
                    renderables.buffer[i] is DeferredLight,
