...
namespace Nez.Textures
{
    ...
    public class Subtexture
    {
        ...
        public Subtexture(Texture2D texture, Rectangle sourceRect)
            : this(texture, sourceRect, sourceRect.getHalfSize())
        {
        }
        ...
        public Subtexture(Texture2D texture, int x, int y, int width, int height)
        ...
        public void generateNinePatchRects(
        ...
        {
            return new Subtexture(texture2D, sourceRect) { origin = origin };
        }
        ...
        public static List<Subtexture> subtexturesFromAtlas(
            Texture2D texture,
            int cellWidth,
            int cellHeight,
            int cellOffset = 0,
            int maxCellsToInclude = int.MaxValue)
        {
            ...
            for (var y = 0; y < rows; y++)
            {
                for (var x = 0; x < cols; x++)
                {
                    ...
                    subtextures.Add(
                        new Subtexture(texture, new Rectangle(x * cellWidth, y * cellHeight, cellWidth, cellHeight)));
