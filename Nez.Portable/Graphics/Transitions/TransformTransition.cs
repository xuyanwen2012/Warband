...
namespace Nez
{
    public class TransformTransition : SceneTransition
    {
        ...
        public TransformTransition(
            Func<Scene> sceneLoadAction,
            TransformTransitionType transitionType = TransformTransitionType.ZoomOut)
            : base(sceneLoadAction, true)
        {
            ...
            switch (transitionType)
            {
                ...
                case TransformTransitionType.ZoomIn:
                    _finalRenderRect = new Rectangle(
                        -Screen.width * 5,
                        -Screen.height * 5,
        ...
        public override IEnumerator onBeginTransition()
        {
            ...
            while (elapsed < duration)
            {
                ...
                _destinationRect = Lerps.ease(
                    transitionEaseType,
                    ref _textureBounds,
                    ref _finalRenderRect,
                    elapsed,
                    duration);
