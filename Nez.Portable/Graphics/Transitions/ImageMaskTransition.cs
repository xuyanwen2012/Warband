...
namespace Nez
{
    ...
    public class ImageMaskTransition : SceneTransition
    {
        ...
        public ImageMaskTransition(Func<Scene> sceneLoadAction, Texture2D maskTexture)
            : base(sceneLoadAction, true)
        {
            _maskPosition = new Vector2(Screen.width / 2, Screen.height / 2);
            _maskRenderTarget = new RenderTarget2D(
                Core.graphicsDevice,
                Screen.width,
                Screen.height,
                false,
        ...
        public ImageMaskTransition(Texture2D maskTexture)
            : this(null, maskTexture)
        {
        }
