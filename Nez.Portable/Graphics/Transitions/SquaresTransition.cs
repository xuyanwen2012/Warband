...
namespace Nez
{
    ...
    public class SquaresTransition : SceneTransition
    {
        ...
        public Color squareColor
        {
            set
            {
                _squaresEffect.Parameters["_color"].SetValue(value.ToVector4());
            }
        }
        ...
        public float smoothness
        {
            set
            {
                _squaresEffect.Parameters["_smoothness"].SetValue(value);
            }
        }
        ...
        public Vector2 size
        {
            set
            {
                _squaresEffect.Parameters["_size"].SetValue(value);
            }
        }
        ...
        public SquaresTransition(Func<Scene> sceneLoadAction)
