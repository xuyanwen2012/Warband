...
namespace Nez
{
    ...
    public class TextureWipeTransition : SceneTransition
    {
        ...
        public float opacity
        {
            set
            {
                _textureWipeEffect.Parameters["_opacity"].SetValue(value);
            }
        }
        ...
        public Color color
        {
            set
            {
                _textureWipeEffect.Parameters["_color"].SetValue(value.ToVector4());
            }
        }
        ...
        public Texture2D transitionTexture
        {
            set
            {
                _textureWipeEffect.Parameters["_transitionTex"].SetValue(value);
            }
        }
        ...
        public bool useRedGreenChannelsForDistortion
        {
            set
            {
                _textureWipeEffect.CurrentTechnique =
        ...
        public TextureWipeTransition(Func<Scene> sceneLoadAction, Texture2D transitionTexture)
        ...
        public TextureWipeTransition(Func<Scene> sceneLoadAction)
            : this(sceneLoadAction, Core.content.Load<Texture2D>("nez/textures/textureWipeTransition/angular"))
        {
        }

        public TextureWipeTransition()
            : this(null, Core.content.Load<Texture2D>("nez/textures/textureWipeTransition/angular"))
        {
        }

        public TextureWipeTransition(Texture2D transitionTexture)
            : this(null, transitionTexture)
        {
        }
