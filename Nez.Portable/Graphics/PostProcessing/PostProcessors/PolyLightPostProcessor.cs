...
namespace Nez
{
    ...
    public class PolyLightPostProcessor : PostProcessor
    {
        ...
        public float multiplicativeFactor
        {
            get
            {
                return _multiplicativeFactor;
            }

            set
            {
                setMultiplicativeFactor(value);
            }
        }
        ...
        public float blurRenderTargetScale
        {
            get
            {
                return _blurRenderTargetScale;
            }

            set
            {
                setBlurRenderTargetScale(value);
            }
        }
        ...
        public float blurAmount
        {
            get
            {
                return _blurEffect != null ? _blurEffect.blurAmount : -1;
            }
        ...
        public PolyLightPostProcessor(int executionOrder, RenderTexture lightsRenderTexture)
            : base(executionOrder)
        {
        ...
        public override void process(RenderTarget2D source, RenderTarget2D destination)
        {
            if (_blurEnabled)
            {
                ...
                var tempRenderTarget = RenderTarget.getTemporary(
                    ...
                    (int)(sceneRenderTargetSize.Y * _blurRenderTargetScale),
                    DepthFormat.None);
