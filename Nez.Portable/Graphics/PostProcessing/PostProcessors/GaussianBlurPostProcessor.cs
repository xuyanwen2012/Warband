...
namespace Nez
{
    public class GaussianBlurPostProcessor : PostProcessor<GaussianBlurEffect>
    {
        ...
        public GaussianBlurPostProcessor(int executionOrder)
            : base(executionOrder, new GaussianBlurEffect())
        {
        }
        ...
        public override void process(RenderTarget2D source, RenderTarget2D destination)
        {
            ...
            var tempRenderTarget = RenderTarget.getTemporary(
                (int)(sceneRenderTargetSize.X * _renderTargetScale),
                (int)(sceneRenderTargetSize.Y * _renderTargetScale),
                DepthFormat.None);
