    ...
    public class PixelMosaicRenderDelegate : IFinalRenderDelegate
    {
        ...
        public void onSceneBackBufferSizeChanged(int newWidth, int newHeight)
        {
            ...
            if (_mosaicRenderTex != null)
            {
                ...
                _mosaicRenderTex = RenderTarget.create(
                    newWidth * scene.pixelPerfectScale,
                    newHeight * scene.pixelPerfectScale,
                    DepthFormat.None);
            }
            else
            {
            ...
            Graphics.instance.batcher.draw(
                _mosaicTexture,
                Vector2.Zero,
                new Rectangle(0, 0, _mosaicRenderTex.Width, _mosaicRenderTex.Height),
                Color.White);
