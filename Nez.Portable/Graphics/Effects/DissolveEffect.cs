...
namespace Nez
{
    public class DissolveEffect : Effect
    {
        ...
        public Color dissolveThresholdColor
        {
            get
            {
                return _dissolveThresholdColor;
            }
        ...
        public Texture2D dissolveTexture
        {
            set
            {
                _dissolveTexParam.SetValue(value);
            }
        }
        ...
        public DissolveEffect(Texture2D dissolveTexture)
            : base(Core.graphicsDevice, EffectResource.dissolveBytes)
        {
