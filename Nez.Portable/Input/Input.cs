...
namespace Nez
{
    public static class Input
    {
        ...
        public static Vector2 scaledMousePosition
        {
            get
            {
                return scaledPosition(new Vector2(_currentMouseState.X, _currentMouseState.Y));
            }
        }
        ...
        public static Point mousePositionDelta
        {
            get
            {
                return new Point(_currentMouseState.X, _currentMouseState.Y) - new Point(
        ...
        public static Vector2 scaledMousePositionDelta
        {
            get
            {
                var pastPos = new Vector2(
                    _previousMouseState.X - _resolutionOffset.X,
