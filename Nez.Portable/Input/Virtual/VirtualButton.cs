    ...
    public class VirtualButton : VirtualInput
    {
        ...
        public class KeyboardModifiedKey : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.isKeyDown(modifier) && Input.isKeyDown(key);
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.isKeyDown(modifier) && Input.isKeyPressed(key);
                }
            }
        ...
        public class GamePadButton : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isButtonDown(button);
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isButtonPressed(button);
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isButtonReleased(button);
                }
            }
        }
        ...
        public class GamePadLeftTrigger : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isLeftTriggerDown(threshold);
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isLeftTriggerPressed(threshold);
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isLeftTriggerReleased(threshold);
                }
            }
        }
        ...
        public class GamePadRightTrigger : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isRightTriggerDown(threshold);
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isRightTriggerPressed(threshold);
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.gamePads[gamepadIndex].isRightTriggerReleased(threshold);
                }
            }
        }
        ...
        public class GamePadDPadRight : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadRightDown;
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadRightPressed;
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadRightReleased;
                }
            }
        }
        ...
        public class GamePadDPadLeft : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadLeftDown;
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadLeftPressed;
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadLeftReleased;
                }
            }
        }
        ...
        public class GamePadDPadUp : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadUpDown;
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadUpPressed;
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadUpReleased;
                }
            }
        }
        ...
        public class GamePadDPadDown : Node
        {
            ...
            public override bool isDown
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadDownDown;
                }
            }
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadDownPressed;
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.gamePads[gamepadIndex].DpadDownReleased;
                }
            }
        }
        ...
        public class MouseLeftButton : Node
        {
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.leftMouseButtonPressed;
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.leftMouseButtonReleased;
                }
            }
        }
        ...
        public class MouseRightButton : Node
        {
            ...
            public override bool isPressed
            {
                get
                {
                    return Input.rightMouseButtonPressed;
                }
            }
            ...
            public override bool isReleased
            {
                get
                {
                    return Input.rightMouseButtonReleased;
                }
            }
        }
